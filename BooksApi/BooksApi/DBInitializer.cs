    ...
    public class DBInitializer
    {
        ...
        public static void Initialize(LibraryContext context)
        {
            ...
            if (!context.Books.Any())
            {
                ...
                //CHAPTERS
                chapters.Add(new Chapters { Chaptrs = 10 });
                chapters.Add(new Chapters { Chaptrs = 15 });
                chapters.Add(new Chapters { Chaptrs = 14 });
                chapters.Add(new Chapters { Chaptrs = 15 });
                chapters.Add(new Chapters { Chaptrs = 17 });
                chapters.Add(new Chapters { Chaptrs = 18 });
                chapters.Add(new Chapters { Chaptrs = 19 });
                chapters.Add(new Chapters { Chaptrs = 10 });
                chapters.Add(new Chapters { Chaptrs = 15 });
                chapters.Add(new Chapters { Chaptrs = 14 });
                chapters.Add(new Chapters { Chaptrs = 15 });
